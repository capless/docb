...
class CloudantDB(DocDB):
    ...
    # Indexing Methods
    def get_doc_list(self, filters_list, sortingp_list):
        query_params = self.parse_filters(filters_list, sortingp_list)
        response = Query(self._db, **query_params)
        return response()['docs']

    def parse_filters(self, filters, sortingp_list):
